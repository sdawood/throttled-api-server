...
module.exports = {
    ...
    "rules": {
        // // changes bstudds 2018-03-16
        "no-undefined": "off", // Keep? undefined triggers default function arguments, null doesn't
        "no-param-reassign": "off", // defaults to off in eslint:recommended, we had "warn"
        "comma-dangle": ["error", "only-multiline"], // Need to decide whether to enforce or not and adopt one.
        "no-magic-numbers": ["warn", { "ignore": [0] }], // Ignore specifically 0 (generally used to reference start of array)
        "no-empty-function": "warn", // should be removed once eslint: recommended,
        "no-unused-vars": ["warn", { "varsIgnorePattern": "__" }],
        "max-statements" : ["warn", 20], // default is 10 statements - a bit too restrictive maybe
